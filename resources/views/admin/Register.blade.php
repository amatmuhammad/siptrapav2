...
<html
  ...
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('assets1/assets/vendor/css/pages/page-auth.css') }}" />
        ...
        <div class="authentication-inner">
          ...
          <div class="card px-sm-6 px-0">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center mb-6">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="{{ asset('assets1/assets/img/elements/LOGO UHO 1 (1).png') }}" alt="" style="width: 60px;">
                  </span>
                  <span class="app-brand-text demo fw-bold">SISTEM PEMODELAN TRANSPORTASI PANGAN</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-1 text-center">Selamat Datang</h4>
              <p class="mb-6 text-center">Buat akun anda disini sehingga anda bisa terdaftar di aplikasi ini</p>
              ...
              <p class="text-center">
                <span>Anda Telah Memiliki Akun?</span>
